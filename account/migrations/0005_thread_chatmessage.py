# Generated by Django 4.1.5 on 2023-01-03 05:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('account', '0004_user_reporting_to'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='account.thread')),
